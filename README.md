## canvas drawer 此demo是uniapp的，也可以用在微信小程序中，文档不全，有问题可以在issues提
...
```
git clone https://github.com/liminFle/canvasDrawer.git
```
...
[此组件根据这个改编优化的](https://github.com/kuckboy1994/mp_canvas_drawer)
